...
from store.api_views import ProductList, ProductCreate, ProductRetrieveUpdateDestroy, ProductStatView
import store.views
...
urlpatterns = [
	...
	path('api/v1/products/<int:id>/stats/',ProductStatView.as_view()),
